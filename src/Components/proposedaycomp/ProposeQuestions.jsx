  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-white py-32 px-6 flex items-center justify-center">
      ...
      {step === "questions" && currentQ && (
        <div
          className="
            bg-white/70 backdrop-blur-xl rounded-[40px] shadow-2xl
            px-12 py-16 max-w-4xl text-center
            min-h-[520px] max-h-[520px] w-full
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            {currentQ.type === "emotion" && (
              <>
                <p className="mt-6 italic text-rose-500">
                  {currentQ.line}
                </p>
